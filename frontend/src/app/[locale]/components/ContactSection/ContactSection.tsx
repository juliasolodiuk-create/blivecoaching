...
export const ContactSection = () => {
  ...
  return (
    <section className="relative h-full bg-[#E7EBFA] w-screen p-16 text-[#242424] -z-1">
      <div className="absolute inset-0 flex items-center justify-center w-screen opacity-50 ">

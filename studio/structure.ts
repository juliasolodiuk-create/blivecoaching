	...
	S.list()
		...
		.items([
			...
			S.listItem()
				...
				.icon(HighlightIcon)
				.child(
					S.document().schemaType("highlight").documentId("highlight_blog"),
				),
			S.divider(),
			S.listItem()
				.title("Про Мене")
			...
			S.listItem()
				...
				.child(
					S.document()
						.schemaType("heroTitleScroll")
						.documentId("beLiveCoaching_heroTitleScroll"),
				),
			S.listItem()
			...
			S.listItem()
				...
				.child(
					S.list()
						.title("Розділи")
						.items([
							S.documentListItem().schemaType("howItWorks").id("howItWorks"),
						]),
				),
			S.divider(),
			S.listItem()
